namespace SoftwareVVNZ.Forms.Raport {
  partial class ExtractResultsForSemesterForm {
    /// <summary>
    ...
    private void InitializeComponent() {
      ...
      this.Name = "ExtractResultsForSemesterForm";
      this.Text = "Виписка за результатами навчання за семестр ";
