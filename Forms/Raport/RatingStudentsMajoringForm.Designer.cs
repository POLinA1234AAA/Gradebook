namespace SoftwareVVNZ.Forms.Raport {
  partial class RatingStudentsMajoringForm {
    /// <summary>
    ...
    private void InitializeComponent() {
      ...
      this.Name = "RatingStudentsMajoringForm";
      this.Text = "Рейтинг студентів  спеціальності по курсам ";
